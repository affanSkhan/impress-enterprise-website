      ...
      <aside className={`fixed top-16 left-0 bottom-0 w-64 bg-white shadow-xl transition-transform duration-300 z-40 overflow-y-auto border-r border-gray-200 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <nav className="p-4 min-h-full flex flex-col">
          ...
          <div className="space-y-6 flex-1">
            ...
            {/* Catalog Management */}
            <div>
              <p className="px-4 text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Catalog Management</p>
              <ul className="space-y-1">
                <li>
                  <Link
                    href="/admin/products"
            ...
            {/* Sales & Finance */}
            <div>
              <p className="px-4 text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Sales & Finance</p>
              <ul className="space-y-1">
                <li>
                  <Link
                    href="/admin/orders"
             ...
             <div>
              <p className="px-4 text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">System</p>
               <Link
                    href="/admin/settings"
                    className={`flex items-center px-4 py-2.5 rounded-lg transition-all text-sm font-medium text-gray-700 hover:bg-gray-100 mt-1`}
                  >
                    <svg className="w-5 h-5 mr-3 opacity-70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
