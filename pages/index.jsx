                ...
                <div className="grid md:grid-cols-2 gap-8 md:gap-12 p-6 sm:p-12 items-center relative z-10">
                  <div className="text-left space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2">
                      <Link href="/contact" className="w-full sm:w-auto text-center px-6 sm:px-8 py-3 sm:py-3.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl font-bold transition-all shadow-lg hover:shadow-indigo-500/25 hover:-translate-y-1 active:scale-95">
                        Book a Service
                      </Link>
                      <Link href="tel:+919763050759" className="w-full sm:w-auto text-center px-6 sm:px-8 py-3 sm:py-3.5 bg-white/5 hover:bg-white/10 text-white rounded-xl font-bold backdrop-blur-sm transition-all border border-white/10 hover:border-white/20 active:scale-95">
                        Call Now
                      </Link>
                    </div>
                  </div>
