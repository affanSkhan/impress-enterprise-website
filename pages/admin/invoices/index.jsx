                 ...
                 <button className="btn-primary">
                    ...
                    <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg z-50 hidden group-hover:block border border-gray-100">
                        <div className="py-1">
                            ...
                            <Link href="/admin/invoices/new?type=solar" className="block px-4 py-2 text-sm text-gray-700 hover:bg-orange-50 hover:text-orange-600">
                                Solar Invoice
                            </Link>
                            <Link href="/admin/invoices/new?type=electronics" className="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600">
                                Electronic Invoice
                            </Link>
                             <Link href="/admin/invoices/new?type=furniture" className="block px-4 py-2 text-sm text-gray-700 hover:bg-emerald-50 hover:text-emerald-600">
                                Furniture Invoice
                            </Link>
                        </div>
                    </div>
